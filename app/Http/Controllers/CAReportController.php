...
class CAReportController extends Controller
{
    ...
    //Commercial Aggereator Individual Report Controller
    ...
    public function search()
    {
        ...
        return view('ca_nvsc.ca_report.report',compact('ptypes','years','months'));
    ...
    public function result(Request $request)
    {
       ...
       tbl_units.unit, tbl_cssupply.price from  tbl_cssupply 
       ...
       // dd($sql);
        ...
        return view('ca_nvsc.ca_report.report_details',compact('surplus','fromdate','todate'));
    }
}
