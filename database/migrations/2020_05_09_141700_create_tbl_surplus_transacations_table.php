...
class CreateTblSurplusTransacationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_surplus_transacations', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tbl_surplus_transacations');
    }
}
