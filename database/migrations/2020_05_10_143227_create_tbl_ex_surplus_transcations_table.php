...
class CreateTblExSurplusTranscationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_ex_surplus_transcations', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tbl_ex_surplus_transcations');
    }
}
