    ...
    <div class="card-header">
      ...
      <div class="row">
        <div class="col text-left">
          <strong>Active - Submitted Surplus.
          </strong>
        </div>
      ...
      <table id="example3" class="display table table-bordered">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{{$report->taken}} {{$report->unit}}</td>
    ...
    //  "serverSide" : true,
      ...
      //  },
       drawCallback: function () {
        var bsum = $('#example3').DataTable().column(4).data().sum();
        var tsum = $('#example3').DataTable().column(5).data().sum();
        var gsum = $('#example3').DataTable().column(6).data().sum();
       // console.log('sum:'+sum);
