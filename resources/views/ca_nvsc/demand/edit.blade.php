...
<form method="POST" action={{route('update-store',$individuals->id)}}  >
    @csrf
<div class="row">
    ...
    <div class="row">
      ...
      <div class="row">
          ...
          <div class="col-md-3 mb-3">
              ...
              <input type="date" value="{{$individuals->tentativeRequiredDate}}" class="form-control" name="date" id="date" required>
