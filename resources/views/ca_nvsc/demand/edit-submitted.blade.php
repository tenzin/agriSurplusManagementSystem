...
<form method="POST" action="{{route('update_submitted',$demand->id)}}" >
@csrf
<div class="row">
        ...
        <div class="col-md-3 mb-3">
          ...
          <div class="col-md-3 mb-3">
              ...
              <div class="input-group">
                  ...
                  <input type="text" value="{{$demand->price}}" name="price" id="price" >
          ...
          <div class="col-md-3 mb-3">
            ...
            <input type="date" value="{{$demand->tentativeRequiredDate}}" class="form-control" name="date" id="date" required readonly>
