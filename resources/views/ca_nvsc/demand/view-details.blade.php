...
<div class="container">
    ...
    <form>
      ...
      <div class="row">
          ...
          <div class="col-md-4 mb-3">
              <label for="unit">PickupDate(Tentative)</label>
               <input type="date" class="form-control" name="pickupdate" id ="pickupdate" readonly value={{$row->tentativeRequiredDate}}>
      ...
      <hr class="mb-4">
     <center> <a class="btn btn-primary btn-xx" href="{{route('view_surplus_demand_details')}}">Back</a></center>
