        ...
        <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-3 mb-3">
                      ...
                      <input type="date" class="form-control" name="date" id ="date" placeholder ="Required Date" required>
                      <div class="invalid-feedback">
            ...
            <a class="btn btn-success btn-lg btn-block text-white" onclick="myFunction()" aria-required="true">Submit</a>
        </div><!-- /.card-body -->
      </div>
      <!-- /.nav-tabs-custom -->
    </div>
